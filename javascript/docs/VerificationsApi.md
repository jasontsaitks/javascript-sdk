# IdentityVerification.VerificationsApi
...
let apiInstance = new IdentityVerification.VerificationsApi();
...
let apiInstance = new IdentityVerification.VerificationsApi();
let verifyRequest = new IdentityVerification.VerifyRequest(); // VerifyRequest | 
