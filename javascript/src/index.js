...
* <pre>
* var IdentityVerification = require('index'); // See note below*.
* var xxxSvc = new IdentityVerification.XxxApi(); // Allocate the API class we're going to use.
* var yyyModel = new IdentityVerification.Yyy(); // Construct a model instance.
...
* <pre>
* var xxxSvc = new IdentityVerification.XxxApi(); // Allocate the API class we're going to use.
* var yyy = new IdentityVerification.Yyy(); // Construct a model instance.
* yyyModel.someProperty = 'someValue';
* ...
* var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
* ...
