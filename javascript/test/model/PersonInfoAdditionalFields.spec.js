...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.PersonInfoAdditionalFields();
  });
  ...
  describe('PersonInfoAdditionalFields', function() {
    it('should create an instance of PersonInfoAdditionalFields', function() {
      ...
      //var instane = new IdentityVerification.PersonInfoAdditionalFields();
      //expect(instance).to.be.a(IdentityVerification.PersonInfoAdditionalFields);
    });
