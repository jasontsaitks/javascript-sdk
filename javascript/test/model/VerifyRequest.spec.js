...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.VerifyRequest();
  });
  ...
  describe('VerifyRequest', function() {
    it('should create an instance of VerifyRequest', function() {
      ...
      //var instane = new IdentityVerification.VerifyRequest();
      //expect(instance).to.be.a(IdentityVerification.VerifyRequest);
    });
