...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.TransactionRecordResultAllOf();
  });
  ...
  describe('TransactionRecordResultAllOf', function() {
    it('should create an instance of TransactionRecordResultAllOf', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.TransactionRecordResultAllOf();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.TransactionRecordResultAllOf);
    });
