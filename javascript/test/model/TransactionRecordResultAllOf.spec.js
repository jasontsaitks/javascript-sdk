...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.TransactionRecordResultAllOf();
  });
  ...
  describe('TransactionRecordResultAllOf', function() {
    it('should create an instance of TransactionRecordResultAllOf', function() {
      ...
      //var instane = new IdentityVerification.TransactionRecordResultAllOf();
      //expect(instance).to.be.a(IdentityVerification.TransactionRecordResultAllOf);
    });
