...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.TransactionRecordResultAllOf();
  });
  ...
  describe('TransactionRecordResultAllOf', function() {
    it('should create an instance of TransactionRecordResultAllOf', function() {
      ...
      //var instane = new KentTestIdentityVerification.TransactionRecordResultAllOf();
      //expect(instance).to.be.a(KentTestIdentityVerification.TransactionRecordResultAllOf);
    });
