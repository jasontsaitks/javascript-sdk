...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.AppendedField();
  });
  ...
  describe('AppendedField', function() {
    it('should create an instance of AppendedField', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.AppendedField();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.AppendedField);
    });
