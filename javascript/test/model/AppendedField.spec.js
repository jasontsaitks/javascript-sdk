...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.AppendedField();
  });
  ...
  describe('AppendedField', function() {
    it('should create an instance of AppendedField', function() {
      ...
      //var instane = new IdentityVerification.AppendedField();
      //expect(instance).to.be.a(IdentityVerification.AppendedField);
    });
