...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.DataFieldsKYC();
  });
  ...
  describe('DataFieldsKYC', function() {
    it('should create an instance of DataFieldsKYC', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.DataFieldsKYC();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.DataFieldsKYC);
    });
