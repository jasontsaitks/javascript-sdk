...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.DataFieldsKYC();
  });
  ...
  describe('DataFieldsKYC', function() {
    it('should create an instance of DataFieldsKYC', function() {
      ...
      //var instane = new IdentityVerification.DataFieldsKYC();
      //expect(instance).to.be.a(IdentityVerification.DataFieldsKYC);
    });
