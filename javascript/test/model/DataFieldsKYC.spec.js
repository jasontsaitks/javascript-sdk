...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.DataFieldsKYC();
  });
  ...
  describe('DataFieldsKYC', function() {
    it('should create an instance of DataFieldsKYC', function() {
      ...
      //var instane = new KentTestIdentityVerification.DataFieldsKYC();
      //expect(instance).to.be.a(KentTestIdentityVerification.DataFieldsKYC);
    });
