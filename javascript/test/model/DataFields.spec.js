...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.DataFields();
  });
  ...
  describe('DataFields', function() {
    it('should create an instance of DataFields', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.DataFields();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.DataFields);
    });
