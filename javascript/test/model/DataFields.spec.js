...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.DataFields();
  });
  ...
  describe('DataFields', function() {
    it('should create an instance of DataFields', function() {
      ...
      //var instane = new KentTestIdentityVerification.DataFields();
      //expect(instance).to.be.a(KentTestIdentityVerification.DataFields);
    });
