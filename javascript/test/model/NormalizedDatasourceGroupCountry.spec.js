...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.NormalizedDatasourceGroupCountry();
  });
  ...
  describe('NormalizedDatasourceGroupCountry', function() {
    it('should create an instance of NormalizedDatasourceGroupCountry', function() {
      ...
      //var instane = new IdentityVerification.NormalizedDatasourceGroupCountry();
      //expect(instance).to.be.a(IdentityVerification.NormalizedDatasourceGroupCountry);
    });
