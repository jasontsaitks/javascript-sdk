...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.NationalId();
  });
  ...
  describe('NationalId', function() {
    it('should create an instance of NationalId', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.NationalId();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.NationalId);
    });
