...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.Communication();
  });
  ...
  describe('Communication', function() {
    it('should create an instance of Communication', function() {
      ...
      //var instane = new IdentityVerification.Communication();
      //expect(instance).to.be.a(IdentityVerification.Communication);
    });
