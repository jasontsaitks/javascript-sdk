...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.TransactionRecordResult();
  });
  ...
  describe('TransactionRecordResult', function() {
    it('should create an instance of TransactionRecordResult', function() {
      ...
      //var instane = new IdentityVerification.TransactionRecordResult();
      //expect(instance).to.be.a(IdentityVerification.TransactionRecordResult);
    });
