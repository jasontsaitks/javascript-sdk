...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.DatasourceResult();
  });
  ...
  describe('DatasourceResult', function() {
    it('should create an instance of DatasourceResult', function() {
      ...
      //var instane = new IdentityVerification.DatasourceResult();
      //expect(instance).to.be.a(IdentityVerification.DatasourceResult);
    });
