...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.VerifyResult();
  });
  ...
  describe('VerifyResult', function() {
    it('should create an instance of VerifyResult', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.VerifyResult();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.VerifyResult);
    });
