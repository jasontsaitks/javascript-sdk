...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.VerifyResult();
  });
  ...
  describe('VerifyResult', function() {
    it('should create an instance of VerifyResult', function() {
      ...
      //var instane = new IdentityVerification.VerifyResult();
      //expect(instance).to.be.a(IdentityVerification.VerifyResult);
    });
