...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.Record();
  });
  ...
  describe('Record', function() {
    it('should create an instance of Record', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.Record();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.Record);
    });
