...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.Record();
  });
  ...
  describe('Record', function() {
    it('should create an instance of Record', function() {
      ...
      //var instane = new KentTestIdentityVerification.Record();
      //expect(instance).to.be.a(KentTestIdentityVerification.Record);
    });
