...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.Location();
  });
  ...
  describe('Location', function() {
    it('should create an instance of Location', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.Location();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.Location);
    });
