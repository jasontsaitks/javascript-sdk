...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.TransactionStatus();
  });
  ...
  describe('TransactionStatus', function() {
    it('should create an instance of TransactionStatus', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.TransactionStatus();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.TransactionStatus);
    });
