...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.TransactionStatus();
  });
  ...
  describe('TransactionStatus', function() {
    it('should create an instance of TransactionStatus', function() {
      ...
      //var instane = new IdentityVerification.TransactionStatus();
      //expect(instance).to.be.a(IdentityVerification.TransactionStatus);
    });
