...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.DatasourceField();
  });
  ...
  describe('DatasourceField', function() {
    it('should create an instance of DatasourceField', function() {
      ...
      //var instane = new IdentityVerification.DatasourceField();
      //expect(instance).to.be.a(IdentityVerification.DatasourceField);
    });
