...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.DatasourceField();
  });
  ...
  describe('DatasourceField', function() {
    it('should create an instance of DatasourceField', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.DatasourceField();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.DatasourceField);
    });
