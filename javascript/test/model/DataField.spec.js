...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.DataField();
  });
  ...
  describe('DataField', function() {
    it('should create an instance of DataField', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.DataField();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.DataField);
    });
