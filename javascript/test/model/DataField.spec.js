...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.DataField();
  });
  ...
  describe('DataField', function() {
    it('should create an instance of DataField', function() {
      ...
      //var instane = new KentTestIdentityVerification.DataField();
      //expect(instance).to.be.a(KentTestIdentityVerification.DataField);
    });
