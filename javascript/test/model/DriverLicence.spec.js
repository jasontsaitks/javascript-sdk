...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new KentTestIdentityVerification.DriverLicence();
  });
  ...
  describe('DriverLicence', function() {
    it('should create an instance of DriverLicence', function() {
      ...
      //var instane = new KentTestIdentityVerification.DriverLicence();
      //expect(instance).to.be.a(KentTestIdentityVerification.DriverLicence);
    });
