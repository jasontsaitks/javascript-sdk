...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TestOnlyIdentityVerification.DriverLicence();
  });
  ...
  describe('DriverLicence', function() {
    it('should create an instance of DriverLicence', function() {
      ...
      //var instane = new TestOnlyIdentityVerification.DriverLicence();
      //expect(instance).to.be.a(TestOnlyIdentityVerification.DriverLicence);
    });
