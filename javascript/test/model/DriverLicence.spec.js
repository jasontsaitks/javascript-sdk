...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new IdentityVerification.DriverLicence();
  });
  ...
  describe('DriverLicence', function() {
    it('should create an instance of DriverLicence', function() {
      ...
      //var instane = new IdentityVerification.DriverLicence();
      //expect(instance).to.be.a(IdentityVerification.DriverLicence);
    });
